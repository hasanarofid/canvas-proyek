...
if (isset($_POST['submit'])) {
    ...
    if (in_array($file_ext, $allowed_types)) {
        ...
        $new_filename = 'profile_' . $program_manager_id . '.' . $file_ext;
        ...
        // Update the program_manager in the database
        $update_query = "UPDATE program_manager 
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    $user_data_query = mysqli_query($conn, "SELECT * FROM program_manager where id = '$user_id' ");
                    if (!$user_data_query) {
