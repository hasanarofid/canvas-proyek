...
if (isset($_POST['submit'])) {
    ...
    if ($password !== $passwordUlang) {
        ...
        $checkUserQuery = "SELECT * FROM mentor WHERE email = ? AND nohp = ?";
        ...
        if ($result->num_rows > 0) {
            ...
            $updateQuery = "UPDATE mentor SET password = ? WHERE email = ? AND nohp = ?";
...
<body>
    ...
    <div class="container">
        ...
        <div class="d-flex flex-column mb-1">
                <h4 class="mt-5 text-center">Canvas - Lupa Password Mentor</h4>
